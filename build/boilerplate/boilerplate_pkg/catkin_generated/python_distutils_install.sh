...
echo_and_run cd "/VirtualShare/uva-robotics/main/src/boilerplate/boilerplate_pkg"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/VirtualShare/uva-robotics/main/build/boilerplate/boilerplate_pkg" \
    install \
    $DESTDIR_ARG \
