...
echo_and_run cd "/VirtualShare/uva-robotics/main/src/speech_recognition/wake_word_engine"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/VirtualShare/uva-robotics/main/build/speech_recognition/wake_word_engine" \
    install \
    $DESTDIR_ARG \
