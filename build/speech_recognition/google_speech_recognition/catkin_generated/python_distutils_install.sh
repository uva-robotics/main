...
echo_and_run cd "/VirtualShare/uva-robotics/main/src/speech_recognition/google_speech_recognition"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/VirtualShare/uva-robotics/main/build/speech_recognition/google_speech_recognition" \
    install \
    $DESTDIR_ARG \
