...
echo_and_run cd "/VirtualShare/uva-robotics/main/src/image_recognition/object_recognition_tensorflow"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/VirtualShare/uva-robotics/main/build/image_recognition/object_recognition_tensorflow" \
    install \
    $DESTDIR_ARG \
