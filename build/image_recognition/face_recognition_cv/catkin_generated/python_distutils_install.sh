...
echo_and_run cd "/VirtualShare/uva-robotics/main/src/image_recognition/face_recognition_cv"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/VirtualShare/uva-robotics/main/build/image_recognition/face_recognition_cv" \
    install \
    $DESTDIR_ARG \
