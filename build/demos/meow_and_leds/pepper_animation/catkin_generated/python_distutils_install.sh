...
echo_and_run cd "/VirtualShare/uva-robotics/main/src/demos/meow_and_leds/pepper_animation"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/VirtualShare/uva-robotics/main/build/demos/meow_and_leds/pepper_animation" \
    install \
    $DESTDIR_ARG \
